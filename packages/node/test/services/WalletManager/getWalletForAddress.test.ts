...
import { makeAddress } from '@dethnode/chain'

describe('WalletManager.getWalletForAddress', () => {
  it('gets wallet if exist', () => {
    const walletManager = new WalletManager()

    walletManager.addFromPrivateKey(
      '0x7045641ca116966a2bd5cd118bc001873ef025e5be60de68237e036fb5be1a58'
    )

    const wallet = walletManager.getWalletForAddress(
      makeAddress('0x39753A8556C680b32088f487A1c6F02C8667db47')
    )

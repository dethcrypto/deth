...
import { Address, makeAddress } from '@dethnode/chain'
...
export class WalletManager {
  ...
  constructor(
    privateKeys?: ReadonlyArray<string>,
  ...
  addWallet(wallet: Wallet): Wallet {
    ...
    const finalWallet = this.defaultProvider
      ? wallet.connect(this.defaultProvider)
      : wallet

...
export class StateManagerAdapter {
  ...
  putContractStorage = callbackify(
    async (address: Buffer, key: Buffer, value: Buffer) => {
  ...
  checkpoint = callbackifySync(
    this.dethStateManager.checkpoint.bind(this.dethStateManager)
  )
  commit = callbackifySync(
    this.dethStateManager.commit.bind(this.dethStateManager)
  )
  revert = callbackifySync(
    this.dethStateManager.revert.bind(this.dethStateManager)
  )

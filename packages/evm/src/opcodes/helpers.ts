...
export function makeUnaryOp(
  ...
  return (ctx: ExecutionContext) => {
    ctx.useGas(gasCost)
    ctx.stack.push(operation(ctx.stack.pop()))
  }
}
...
export function makeBinaryOp(
  ...
  return (ctx: ExecutionContext) => {
    ctx.useGas(gasCost)
    ctx.stack.push(operation(ctx.stack.pop(), ctx.stack.pop()))
  }
}
...
export function makeTernaryOp(
  ...
  return (ctx: ExecutionContext) => {
    ctx.useGas(gasCost)
    ctx.stack.push(operation(ctx.stack.pop(), ctx.stack.pop(), ctx.stack.pop()))
  }
}

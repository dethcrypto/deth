...
export default [
  ...
  {
    stack: [Int256.MAX_SIGNED, Int256.of(0xf8)],
    expected: Int256.of(0x7f),
  },
  {
    stack: [Int256.MAX_SIGNED, Int256.of(0xfe)],
    expected: Int256.of(1),
  },
  {
    stack: [Int256.MAX_SIGNED, Int256.of(0xff)],
    expected: Int256.of(0),
  },
  {
    stack: [Int256.MAX_SIGNED, Int256.of(0x0100)],
    expected: Int256.of(0),
  },
]
